...
public final class MentorErrorMapper {
    private MentorErrorMapper() {
    ...
    private static final Map<Status.Code, BusinessErrorCode> ERROR_CODE_MAP = Map.of(
            ...
            Status.Code.DEADLINE_EXCEEDED, ErrorCode.MENTOR_SERVER_ERROR
    );
    ...
    public static BusinessErrorCode getBusinessErrorCode(Status.Code code) {
        return ERROR_CODE_MAP.getOrDefault(code, ErrorCode.MENTOR_SERVER_ERROR);
    }
}
